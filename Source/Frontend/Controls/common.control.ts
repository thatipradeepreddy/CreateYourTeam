...
export const createUser = (userData: UserProps) => {
	return new Promise((resolve, reject) => {
		fetch('http://192.168.43.59:5000/createuser', {
			method: 'POST',
			headers: {
...
export const deleteteam = (id: string) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.59:5000/${id}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const deletePlayer = (id: string, name: string) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.59:5000/${id}/${name}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const getPlayerByIdName = (
	...
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.59:5000/getplayerbyname/${id}/${name}`, {
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const postPlayer = (playerData: PlayerProps) => {
	return new Promise((resolve, reject) => {
		fetch('http://192.168.43.59:5000/createdata', {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
			},
...
// 	return new Promise((resolve, reject) => {
// 		fetch(`http://192.168.43.59:5000/addNewPlayer/${id}/${place}`, {
// 			method: 'POST',
// 			headers: {
// 				'Content-Type': 'application/json',
// 			},
...
export const postNewPlayer = (id: string, playerData: PlayerProps) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.59:5000/addNewPlayer/${id}`, {
			method: 'PUT',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const loginUser = (user: any) => {
	...
	return new Promise<{ success: boolean; message?: string }>(
		(resolve, reject) => {
			fetch('http://192.168.43.59:5000/user/login', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
				},
...
export const deleteUser = (id: string) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.59:5000/user/${id}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',
			},
