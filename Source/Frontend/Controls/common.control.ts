...
export const createUser = (userData: UserProps) => {
	return new Promise((resolve, reject) => {
		fetch('http://192.168.43.141:5000/createuser', {
			method: 'POST',
			headers: {
...
export const fetchPlayers = () => {
	return new Promise((resolve, reject) => {
		fetch('http://192.168.43.141:5000/')
			.then((response) => {
				if (!response.ok) {
					throw new Error(`HTTP error! Status: ${response.status}`)
				}
...
export const deleteteam = (id: string) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.141:5000/${id}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const loginUser = (user: any) => {
	...
	return new Promise<{ success: boolean; message?: string }>((resolve, reject) => {
		fetch('http://192.168.43.141:5000/user/login', {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
			},
...
export const deleteUser = (id: string) => {
	return new Promise((resolve, reject) => {
		fetch(`http://192.168.43.141:5000/user/${id}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',
			},
