    ...
    const handleConfirmDelete = () => {
        if (playerToDelete) {
            deleteteam(playerToDelete._id)
                .then(() => {
                    setPlayerState((prevPlayers) => prevPlayers.filter((player) => player._id !== playerToDelete._id))
            ...
            <View style={styles.headerContainer}>
                <View style={styles.headingContainer}>
                    <TouchableOpacity onPress={navigation.goBack}>
                        <Icon style={styles.iconarrow} name="arrow-back" size={23} color="blue" />
                    </TouchableOpacity>
                    <Text style={styles.select}>Add Player</Text>
                </View>
                <View style={styles.headingContainer}>
                    <TouchableOpacity>
                        <Icon style={styles.iconarrow} name={isCheckedAll ? 'checkbox' : 'checkbox-outline'} size={23} />
                    </TouchableOpacity>
                    ...
                    <View key={team._id}>
                        <View style={styles.teamHeader}>
                            ...
                            <View style={styles.teamHeaderInner}>
                                ...
                                <TouchableOpacity onPress={() => handleAddNewPlayer(teamIndex)}>
                                    <View>
                                        <Icon
                                            key={team._id}
                                ...
                                <TouchableOpacity onPress={() => handleDelete(teamIndex)}>
                                    <View>
                                        <Icon key={team._id} style={styles.icontrash} name="trash" size={20} color="black" />
                                    </View>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => toggleTeamExpansion(team._id)}>
                                    <Icon
                            ...
                            team.player.map((player: Player) => (
                                <View style={styles.player} key={player.name}>
                                    ...
                                    <View style={styles.iconsContainer}>
                                        ...
                                        <TouchableOpacity
                                            key={player.name}
                                            onPress={() => handleDeletePlayer(team._id, player.name)}
                                        >
                                            <Icon key={player.name} style={styles.iconarrow} name="trash" size={20} />
                                        </TouchableOpacity>
                                        <TouchableOpacity>
                                            <Icon style={styles.iconarrow} name={'checkbox'} size={23} color="blue" />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            ))
