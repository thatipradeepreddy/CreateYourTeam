		...
		return (
			<View>
				<Text style={styles.description}>
					CYT is an application that invites you to participate in
					village cricket by allowing you to form multiple teams
					comprising players from various villages. It simplifies
					cricket management by providing a platform to store detailed
