...
export function LandingPage() {
    ...
    const renderInitial = () => {
        return (
            <View>
                <Text style={styles.initial}>Welcome to</Text>
            </View>
        )
    }
    ...
    const renderText = () => {
        return (
            <View>
                <Text style={styles.text}>C Y T</Text>
            </View>
        )
    }
        ...
        return (
            <View>
                <Text style={styles.description}>
                    CYT is an application that invites you to participate in village cricket by allowing you to form multiple
                    teams comprising players from various villages. It simplifies cricket management by providing a platform to
                    store detailed information about all players.
                </Text>
            </View>
        )
    }
