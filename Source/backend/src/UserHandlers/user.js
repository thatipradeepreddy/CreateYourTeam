            ...
            if (result.length > 0) {
                ...
                if (expiresAt < Date.now()) {
                    UserVerification.deleteOne({ userId })
                        ...
                        .catch((error) => {
                            console.log(error)
                            let message = "An error occurred while clearing the expired user record"
                            res.redirect(`/user/verified/error=true&message=${message}`)
                        })
                } else {
                    bcrypt
                ...
                let message = "Account does not exist or has been verified already, please sign up or log in"
                res.redirect(`/user/verified/error=true&message=${message}`)
            }
        })
        .catch((error) => {
            console.log(error)
            let message = "An error occurred while checking for existing user verification"
            res.redirect(`/user/verified/error=true&message=${message}`)
        })
})
                ...
                .then((hashedResetString) => {
                    ...
                    newPasswordReset
                        ...
                        .catch((error) => {
                            ...
                            res.json({
                                status: "FAILED",
                                message: "Could not save the password reset date!",
                            })
                        })
                })
                .catch((error) => {
                ...
                if (expiresAt < Date.now()) {
                    PasswordReset.deleteOne({ userId })
                        ...
                        .catch((error) => {
                            ...
                            res.json({
                                status: "FAILED",
                                message: "Clearing the password record is not found",
                            })
                        })
                } else {
                    bcrypt
                            ...
                            if (result) {
                                ...
                                bcrypt
                                            ...
                                            .then(() => {
                                                PasswordReset.deleteOne({
                                                    ...
                                                    .catch((error) => {
                                                        ...
                                                        res.json({
                                                            status: "FAILED",
                                                            message: "An error occured while finalising the password",
                                                        })
                                                    })
                                            })
                                            .catch((error) => {
                                    ...
                                    .catch((error) => {
                                        ...
                                        res.json({
                                            status: "FAILED",
                                            message: "An error occured while hashing the passwords",
                                        })
                                    })
                            } else {
                                res.json({
